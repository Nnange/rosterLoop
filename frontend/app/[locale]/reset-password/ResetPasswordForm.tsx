...
export default function ResetPasswordForm() {
  ...
  if (tokenValid === null) {
    return (
      <div className="flex flex-col min-h-screen items-center justify-center pt-8 px-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-950">
        <Header />
  ...
  if (!tokenValid) {
    return (
      <div className="flex flex-col min-h-screen items-center justify-center pt-8 px-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-950">
        <Header />
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm dark:bg-gray-800 dark:shadow-black/30">
          <div className="text-center">
            <div className="mb-4">
